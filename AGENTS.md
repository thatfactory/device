...
Device is a reusable Swift package. Read [README.md](README.md) before changing public behavior, supported platforms, or package integration.
...
|---|---|
| Package sources | `Sources/Device/` |
| Unit tests | `Tests/DeviceTests/` |
